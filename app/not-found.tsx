...
export default function NotFound() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f7f7f5] text-[#111]">

      {/* Ambient glow */}
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white blur-3xl" />
      ...
      <section className="relative z-10 flex min-h-screen items-center px-6 py-28 sm:px-10">
        ...
        <div className="mx-auto grid w-full max-w-7xl items-center gap-16 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="relative mx-auto h-[460px] w-full max-w-[430px]">
            ...
            {/* Shadow */}
            <div className="absolute bottom-8 left-1/2 h-16 w-64 -translate-x-1/2 rounded-full bg-black/10 blur-3xl" />

            {/* Main glass card */}
            <div className="absolute left-1/2 top-1/2 h-[330px] w-[260px] -translate-x-1/2 -translate-y-1/2 rotate-[7deg] rounded-[36px] border border-black/10 bg-white/70 p-4 shadow-2xl shadow-black/10 backdrop-blur-xl">
            ...
            {/* Floating mini card */}
            <div className="absolute right-0 top-10 rotate-[-8deg] rounded-2xl border border-black/10 bg-white px-5 py-4 shadow-xl">
            ...
            {/* Floating arrow */}
            <div className="absolute bottom-12 left-0 flex h-16 w-16 items-center justify-center rounded-full border border-black/10 bg-white shadow-lg">
              <FaArrowLeft className="text-sm" />
            </div>

            {/* Decorative crosses */}
            <span className="absolute left-14 top-5 text-xl text-black/20">
              +
            </span>

            <span className="absolute bottom-20 right-12 text-2xl text-black/20">
              ✦
            </span>
